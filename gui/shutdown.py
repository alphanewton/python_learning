...
rt_button = Button(st, text="Restart Timer", font=("Time New Roman", 30, "bold"), relief=RAISED, cursor="plus", command=restart_time())
...
n_button = Button(st, text = "Newton")
n_button.place(x = 150 , y= 470)
